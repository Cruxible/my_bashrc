...
function start_shell_or_venv() {
    ...
    select option in "Start Shell" "Activate Virtual Environment" "Pyra Compiler"; do
        case $option in
            "Start Shell" ) neofetch && echo -e " \033[31m$(date)\033[0m" && break;;
            "Activate Virtual Environment" ) neofetch && echo -e " \033[31m$(date)\033[0m" && cd ~/pyra_env && source bin/activate; break;;
